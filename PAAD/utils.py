...
def config_parser():
    ...
    # parser.add_argument("--delta_phi",default=10.)
    # parser.add_argument("--delta_theta",default=0.)
    # parser.add_argument("--delta_psi",default=0.)
    # parser.add_argument("--delta_t",default=0.)
    
    parser.add_argument("--class_name", type=str, default='15',
...
def load_blender_AD(data_dir, model_name, obs_img_num, half_res, white_bkgd, method,**kwargs):
    ...
    # index=2 is a good start,to test the big anomaly
    # index_largest=2
    # SSIM_largest,_=calculate_resmaps(imgs[index_largest],img_rgb,'ssim')
    # initial_pose = poses[index_largest]
...
def pose_retrieval(imgs,obs_img,poses):
    ...
    gallery_feature = extract_feature_2(model=model, imgs=imgs)
