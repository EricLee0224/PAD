...
**MAD-Sim Dataset (970MB)**: [Google Drive](https://drive.google.com/file/d/1XlW5v_PCXMH49RSKICkskKjd2A5YDMQq/view?usp=sharing).
#### Data Directory
```
MAD-Sim
...
**MAD-Real Dataset(2.19GB)**: [Google Drive](https://drive.google.com/file/d/146sKbkUUFW7xJTG2LGm_OgXjMX3fDNxN/view?usp=sharing)
...
| :--------: | :-------------------------: | :--------: | :--------: | :--------: | :--------: | :------: | :----------------------: | :--------: | :-----: | :--------: | :----------------: |
|            | Patchcore                   | STFPM      | Fastflow   | CFlow      | CFA        | Cutpaste | DREAM                    | FAVAE      | OCRGAN  | UniAD      | OmniposeAD                   |
